...
import type { ExternalBlob as _ExternalBlob, GalleryImage as _GalleryImage, GalleryImageMetadata as _GalleryImageMetadata, Inquiry as _Inquiry, InquiryStatus as _InquiryStatus, ServiceType as _ServiceType, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createInquiry(arg0: string, arg1: string, arg2: string | null, arg3: ServiceType, arg4: string | null, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createInquiry(arg0, arg1, to_candid_opt_n10(this._uploadFile, this._downloadFile, arg2), to_candid_ServiceType_n11(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getInquiry(arg0: bigint): Promise<Inquiry> {
        if (this.processError) {
            try {
                ...
                return from_candid_Inquiry_n21(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async listGalleryImages(): Promise<Array<GalleryImageMetadata>> {
        if (this.processError) {
            try {
    ...
    async uploadGalleryImage(arg0: string, arg1: string, arg2: ExternalBlob, arg3: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadGalleryImage(arg0, arg1, await to_candid_ExternalBlob_n30(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n10(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_GalleryImageMetadata_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GalleryImageMetadata): Promise<GalleryImageMetadata> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
async function from_candid_GalleryImage_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GalleryImage): Promise<GalleryImage> {
    return await from_candid_record_n18(_uploadFile, _downloadFile, value);
}
function from_candid_InquiryStatus_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _InquiryStatus): InquiryStatus {
...
async function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_GalleryImage]): Promise<GalleryImage | null> {
    return value.length === 0 ? null : await from_candid_GalleryImage_n17(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        alt: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.alt)),
...
function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        service: from_candid_ServiceType_n23(_uploadFile, _downloadFile, value.service),
        status: from_candid_InquiryStatus_n25(_uploadFile, _downloadFile, value.status),
        name: value.name,
        email: value.email,
...
function from_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    exteriorWashing: null;
}): ServiceType {
    return "exteriorWashing" in value ? ServiceType.exteriorWashing : value;
}
function from_candid_variant_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? InquiryStatus.pending : "completed" in value ? InquiryStatus.completed : "inProgress" in value ? InquiryStatus.inProgress : "archived" in value ? InquiryStatus.archived : value;
}
async function from_candid_vec_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_GalleryImageMetadata>): Promise<Array<GalleryImageMetadata>> {
    return await Promise.all(value.map(async (x)=>await from_candid_GalleryImageMetadata_n28(_uploadFile, _downloadFile, x)));
}
...
function to_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ServiceType): {
    ...
    return value == ServiceType.exteriorWashing ? {
        exteriorWashing: null
    } : value;
}
